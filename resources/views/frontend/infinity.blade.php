    ...
    <div class="nav-bar-sec nav-bar-sec1  ">
        <nav class="navbar navbar-expand-lg navbar-light bg-light bg-light1">
            <a class="navbar-brand" href="{{ route('frontend.index') }}">
                ...
                @else
                    <img src="images/Mask Group 22.png" style="width: 50%;">
                @endif
            </a>
                            ...
                            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        ...
                                        <!-- Start modal -->
                                        <button type="button" class="req-serv-3" data-toggle="modal"
                                            data-target="#exampleModalCenter{{ $slider->id }}" title="Make Request">
                                            {{ $slider->button }}
                                        </button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('frontend.send-message') }}" method="post">
                                                        @csrf
                                                        <input type="hidden" name="type" value="Infinity" id="Infinity">
                                        ...
                                        @if ($slider->video_src != '')
                                            <button type="button" class="req-serv-3" data-toggle="modal"
                                                data-target="#myModal{{ $slider->id }}" title="Watch Video">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="embed-responsive embed-responsive-16by9">
                                                                <iframe id="cartoonVideo{{ $slider->id }}"
                                                                    class="embed-responsive-item" width="560"
                                                                    height="315" src="{{ $slider->video_src }}"
                                        ...
                                        <div class="col text-right">
                                            @if ($project->video_url != '')
                                                <a href="{{ $project->video_url }}" target="_blank">
                                                    <button type="button" class="mt-2 Request-services"
                                                        title="Go To Video Link">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="row">
                            @foreach ($technologies as $technology)
                                <div class="col">
                                    <img src="{{ $technology->icon }}" style="width: 30%;" />
                                </div>
                            @endforeach
                        </div>
                    </div>
